...
/** @jsx jsx */
import { React, jsx, PageJson, ImmutableObject, BrowserSizeMode, IMThemeVariables, PagePart, IMHeaderJson, IMFooterJson, LayoutInfo, IntlShape, ClipboardItem, DialogJson, IMDialogJson } from 'jimu-core';
...
declare const _default: React.FC<import("react-intl").WithIntlProps<Pick<React.ClassAttributes<PageRenderer> & PageProps & StateToProps, "intl" | "ref" | "key" | "dialogId" | "pageStatus"> & PageProps>> & {
    WrappedComponent: React.ComponentType<Pick<React.ClassAttributes<PageRenderer> & PageProps & StateToProps, "intl" | "ref" | "key" | "dialogId" | "pageStatus"> & PageProps>;
};
