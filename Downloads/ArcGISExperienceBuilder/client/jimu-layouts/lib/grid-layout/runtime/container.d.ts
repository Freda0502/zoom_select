...
export declare const GridContainer: ReactRedux.ConnectedComponent<typeof ContainerClass, Pick<React.ClassAttributes<ContainerClass> & ContainerProps & StateToContainerProps, "layoutId" | "layoutItemId" | "ref" | "key" | "splitterSize" | "splitterColor"> & ContainerProps>;
export {};
