...
}, Pick<import("react-intl").WithIntlProps<DataSourceSelectorProps & StateExtraProps & ExtraProps>, "className" | "onChange" | "widgetId" | "forwardedRef" | "useDataSources" | "useDataSourcesEnabled" | "buttonLabel" | "isMultiple" | "types" | "disableRemove" | "fromRootDsIds" | "disableSelection" | "fromDsIds" | "hideDs" | "hideHeader" | "hideTypeDropdown" | "disableAddData" | "enableToSelectOutputDsFromSelf" | "mustUseDataSource" | "disableDataSourceList" | "disableDataView" | "hideDataView" | "closeDataSourceListOnChange" | "onToggleUseDataEnabled"> & DataSourceSelectorProps>;
export {};
