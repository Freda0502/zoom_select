...
/** @jsx jsx */
import { React, ImmutableArray, Immutable, UseDataSource, IMUseDataSource, IntlShape, jsx, BrowserSizeMode } from 'jimu-core';
...
export declare const MainDataAndViewSelector: React.FC<import("react-intl").WithIntlProps<Pick<React.ClassAttributes<_MainDataAndViewSelector> & MainDataAndViewSelectorProps & ExtraProps & StateToProps, "className" | "onChange" | "intl" | "widgetId" | "ref" | "key" | "useDataSources" | "isSelectedFromRepeatedDataSourceContext" | "useSelectionDataView" | "usePopulatedDataView" | "selectedUseDataSource" | "defaultDataViewPriority" | "hideMainDataSourceSelect"> & MainDataAndViewSelectorProps>> & {
    WrappedComponent: React.ComponentType<Pick<React.ClassAttributes<_MainDataAndViewSelector> & MainDataAndViewSelectorProps & ExtraProps & StateToProps, "className" | "onChange" | "intl" | "widgetId" | "ref" | "key" | "useDataSources" | "isSelectedFromRepeatedDataSourceContext" | "useSelectionDataView" | "usePopulatedDataView" | "selectedUseDataSource" | "defaultDataViewPriority" | "hideMainDataSourceSelect"> & MainDataAndViewSelectorProps>;
};
export {};
