...
/** @jsx jsx */
import { React, jsx, IMDataViewJson, IMUseDataSource, DataSource, IntlShape, IMSqlExpression, OrderByOption, ImmutableObject, WidgetJson, QueryParams } from 'jimu-core';
...
export declare const DataViewSettingPopup: React.FC<import("react-intl").WithIntlProps<Pick<React.ClassAttributes<_DataViewSettingPopup> & DataViewSettingPopupProps & ExtraProps & StateToProps, "className" | "isOpen" | "toggle" | "intl" | "ref" | "key" | "mainDataSource" | "dataView" | "isSettingMainDataSource" | "disableRename" | "disableDuplicate" | "disableRemove" | "newDataViewId" | "newDataViewLabel" | "onApply" | "onDuplicate"> & DataViewSettingPopupProps>> & {
