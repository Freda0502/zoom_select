...
export declare const _IconViewer: ReactRedux.ConnectedComponent<typeof __IconViewer, Pick<React.ClassAttributes<__IconViewer> & IconViewerProps & ExtraProps, "className" | "onChange" | "isOpen" | "icon" | "ref" | "key" | "configurableOption" | "previewOptions" | "groups" | "customIcons" | "onButtonClick" | "onIconUploadError"> & IconViewerProps>;
