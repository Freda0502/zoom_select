 ...
 */
export declare const _IconPicker: ReactRedux.ConnectedComponent<typeof __IconPicker, Pick<React.ClassAttributes<__IconPicker> & IconPickerProps & ExtraProps, "className" | "onChange" | "vertical" | "icon" | "ref" | "key" | "showLabel" | "hideRemove" | "configurableOption" | "previewOptions" | "buttonOptions" | "groups" | "customIcons" | "onButtonClick"> & IconPickerProps>;
/**
