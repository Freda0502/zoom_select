 ...
 */
export declare const BoxShadowSetting: React.ComponentType<Pick<import("react-intl").WithIntlProps<BoxShadowSettingProps & ExtraProps>, "className" | "onChange" | "forwardedRef" | "value"> & BoxShadowSettingProps>;
export {};
