...
declare const _default: ReactRedux.ConnectedComponent<typeof AnimationPopperContent, Pick<React.ClassAttributes<AnimationPopperContent> & OwnProps & StateToProps, "ref" | "key" | "formatMessage" | "effectSetting" | "oneByOneSetting" | "onSettingChange" | "previewEnabled" | "supportOneByOne" | "supportAsOne" | "onPreviewClicked"> & OwnProps>;
