 ...
 */
export declare const SqlExpressionBuilderPopup: React.FC<Pick<React.PropsWithChildren<import("react-intl").WithIntlProps<SqlExpressionBuilderPopupProps & IntlProps>>, "className" | "children" | "onChange" | "isOpen" | "toggle" | "expression" | "dataSource" | "mode" | "forwardedRef"> & {
