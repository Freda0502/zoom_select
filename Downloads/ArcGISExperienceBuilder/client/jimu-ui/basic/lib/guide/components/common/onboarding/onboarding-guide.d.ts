...
export declare const OnboardingGuide: ReactRedux.ConnectedComponent<typeof _OnboardingGuide, Pick<React.ClassAttributes<_OnboardingGuide> & GuideProps & StateToProps, "disabled" | "className" | "steps" | "stepIndex" | "run" | "conditionalStepIndexes" | "onStepChange" | "onActionClick" | "widgetName" | "widgetJson" | "isInjected" | "ref" | "key"> & GuideProps>;
export {};
