...
export declare const VIPredefinedSelector: React.ComponentType<React.PropsWithChildren<Pick<React.PropsWithChildren<import("react-intl").WithIntlProps<PredefinedProps & IntlProps>>, "className" | "style" | "children" | "onChange" | "dataSource" | "sql" | "forwardedRef" | "value" | "runtime" | "fieldObj" | "isSmallSize" | "codedValues" | "isMultiple"> & {
