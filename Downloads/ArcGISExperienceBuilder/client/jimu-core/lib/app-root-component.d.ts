...
declare const _default: React.FC<import("react-intl").WithIntlProps<Pick<React.ClassAttributes<AppRootComponent> & StateProps & IntlProps, "intl" | "ref" | "key"> & IntlProps>> & {
    WrappedComponent: React.ComponentType<Pick<React.ClassAttributes<AppRootComponent> & StateProps & IntlProps, "intl" | "ref" | "key"> & IntlProps>;
};
